...
<head>
    ...
    <link href="{{ asset('template-assets/css/sb-admin-2.min.css') }}" rel="stylesheet">
    <link href="{{ asset('template-assets/vendor/datatables/dataTables.bootstrap4.min.css') }}" rel="stylesheet">
...
<body id="page-top">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle"
                                            src="{{ asset('template-assets/img/undraw_profile_1.svg') }}"
                                            alt="...">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle"
                                            src="{{ asset('template-assets/img/undraw_profile_2.svg') }}"
                                            alt="...">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle"
                                            src="{{ asset('template-assets/img/undraw_profile_3.svg') }}"
                                            alt="...">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="{{ asset('template-assets/img/undraw_profile.svg') }}">
                            </a>
    ...
    <script src="{{ asset('template-assets/js/sb-admin-2.min.js') }}"></script>
